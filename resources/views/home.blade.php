...
<section id="slider"><!--slider-->
    <div class="container">
        <div class="row">
            <div class="col-sm-12"> <!--GAPF simple Carrusel next OWL2-->
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                <h1><span>Gift</span>-Shop</h1>
                                <h2>Pinnacle E-Commerce</h2>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    @foreach ($products as $product)<!--GAP The Magic beggin here -->
                    <div class="col-sm-4">
